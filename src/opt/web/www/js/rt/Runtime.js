...
export class Runtime {
  ...
  constructor(audio, wasmAdapter, window) {
    ...
    this.wasmAdapter.load("/fullmoon.wasm").then((p) => {
      this.loaded = true;
      this.audio.decodeWaves(this.wasmAdapter.readStaticCString("fmnr_waves"));
    }).catch((e) => {
      //TODO Report this where the user will see.
      this.window.console.error(`error loading wasm module`, e);
    });
  }
